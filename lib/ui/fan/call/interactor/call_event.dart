...
class Init extends CallEvent {
  ...
  const Init(this.user, this.inCalling, this.callTiming);

  @override
  List<Object?> get props => [user, inCalling, callTiming];
}
...
class OnMute extends CallEvent {
  const OnMute();
...
class OnOffVideo extends CallEvent {
  const OnOffVideo();
