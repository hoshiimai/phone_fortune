      ...
      child: BlocConsumer<ChangePasswordBloc, ChangePasswordState>(
        ...
        listener: (BuildContext context, ChangePasswordState state) {
          if(state.status == PageState.success) {
            showSuccessDialog(
                title: LocaleKey.changePasswordSuccessTitle.tr,
                message: LocaleKey.changePasswordSuccessContent.tr,
                textConfirm: LocaleKey.backToLogin.tr,
                onConfirmPressed: () {
                      ...
                      children: [
                        ...
                        Center(
                          child: TextButton(
                            onPressed: () {},
                            child: Text(
                              LocaleKey.changePasswordTitle.tr,
                        ...
                        AppTextField(
                          padding: 22.paddingHorizontal.copyWith(top: 14),
                          hintText: LocaleKey.passwordConfirmHint.tr,
                          isPassword: true,
                          iconType: IconType.password,
                          onChanged: (value) {
